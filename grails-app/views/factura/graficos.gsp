...
<g:javascript>
    $( document ).ready(function() {
       var dataPoints = JSON.parse("${datos.encodeAsJson()}");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		...
		indexLabel: "{label} {y}",
		dataPoints: [
		    {y: dataPoints.comprasRealizadas, label: "Total"},
			{y: dataPoints.despachadas, label: "Compras Despachadas"},
			{y: dataPoints.noDespachadas, label: "Compras No despachadas"}
		]
	}]
});
chart.render();
